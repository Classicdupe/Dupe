...
public class Clan {
    ...
    public void setOwner(OfflinePlayer offPlayer) { this.owner = offPlayer; }
    public void addAdmin(OfflinePlayer offPlayer) { this.admins.add(offPlayer); }
    public void addVip(OfflinePlayer offPlayer) { this.vips.add(offPlayer); }
    public void addDefault(OfflinePlayer offPlayer) { this.defaults.add(offPlayer); }
    public void removeAdmin(OfflinePlayer offPlayer) { this.admins.remove(offPlayer); }
    public void removeVip(OfflinePlayer offPlayer) { this.vips.remove(offPlayer); }
    public void removeDefault(OfflinePlayer offPlayer) { this.defaults.remove(offPlayer); }
